...
class Moss2ForCausalLM(Moss2PreTrainedModel):
    ...
    def chat(
        ...
        top_p: float = 0.8,
        meta_instruction: str = "You are an AI assistant whose name is MOSS.\n"
        "- MOSS is a conversational language model that is developed by Fudan University (复旦大学). It is designed to be helpful, honest, and harmless.\n"
